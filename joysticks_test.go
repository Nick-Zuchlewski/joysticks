...
// TODO:
// I dont get why using sound is a good test. This should could should be converter to an interface
// and backend then mocked. However, first we need to ensure working as is.
