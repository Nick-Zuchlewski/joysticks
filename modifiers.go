...
// Duplicator - duplicate event onto two chan's
...
// Repeater - creates a channel that, after receiving any event on the first parameter chan, and until any event on second chan parameter, regularly receives 'when' events.
